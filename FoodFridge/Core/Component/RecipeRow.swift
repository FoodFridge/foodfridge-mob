                ...
                VStack {
                    HStack {
                        Button {
                            ...
                            if !sessionManager.isLoggedIn() {
                                ...
                                Task {
                                    try await UpdateFavoriteRecipe.updateFavorite(linkId: edamanRecipe?.id ?? "id", isFavorite: isLiked)
                                }
                            }
                    ...
                    VStack {
                        ...
                        Button {
                            ...
                            if let link = URL(string: edamanRecipe?.link ?? "Link") {
                                openURL(link)
                            ...
                            */
                            ...
                            AsyncImage(url: URL(string: edamanRecipe?.img ?? "https://www.twopeasandtheirpod.com/wp-content/uploads/2015/01/Peanut-Butter-Apple-Baked-Oatmeal-2.jpg" )) { phase in
                                switch phase {
                                case .empty:
                        ...
                        Button {
                            ...
                            VStack {
                                Text(edamanRecipe?.title ?? "Recipe title")
                                    
                                    .lineLimit(3, reservesSpace: true)
                                    .foregroundStyle(.black)
                                    .font(.custom(CustomFont.appFontBold.rawValue, size: 17))
                                    .padding()
